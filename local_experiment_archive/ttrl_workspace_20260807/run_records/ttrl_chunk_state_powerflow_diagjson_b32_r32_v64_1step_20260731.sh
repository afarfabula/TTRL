...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_diagjson_b32_r32_v64_1step_20260731}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0731-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-diagjson}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/cpdj1}"
