...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_support_flow_gain_mid_c128_b32_r32_v64_2step_20260801}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0801-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-support-flow-gain-smoke}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/csf_gain_2step}"
...
exec bash "$LAUNCHER" \
  ...
  ttrl.chunk_state_support_flow_min_positive_margin=-1.0 \
