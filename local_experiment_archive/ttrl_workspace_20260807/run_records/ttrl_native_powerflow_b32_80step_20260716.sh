...
RUN_ID="ttrl_native_powerflow_ttrlactor_seednull_b32_80step_20260716"
...
export TTRL_RUNTIME_DIR="/tmp/pfttrl80ta"
...
exec "${PY}" -m powerflow.main_powerflow \
  ...
  +actor_rollout_ref.actor.powerflow_use_ttrl_actor=True \
