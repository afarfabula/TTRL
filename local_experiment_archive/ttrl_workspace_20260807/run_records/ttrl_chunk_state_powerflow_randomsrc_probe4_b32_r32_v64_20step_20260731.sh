...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_randomsrc_probe4_b32_r32_v64_20step_20260731}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0731-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-randomsrc-probe4-powerflow}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/csprp420}"
