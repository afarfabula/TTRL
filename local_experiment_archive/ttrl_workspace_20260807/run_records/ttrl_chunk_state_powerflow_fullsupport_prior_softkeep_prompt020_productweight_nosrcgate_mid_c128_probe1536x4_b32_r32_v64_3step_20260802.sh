...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_fullsupport_prior_softkeep_prompt020_productweight_nosrcgate_mid_c128_probe1536x4_b32_r32_v64_3step_20260802}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0802-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-fullsupport-prior-softkeep-prompt020-productweight-nosrcgate-smoke}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/cfsp82e}"
...
exec bash "$BASE" \
  ...
  ttrl.chunk_state_min_prompt_top_mass=0.20 \
  ttrl.chunk_state_source_select_by_mass=True \
  ttrl.chunk_state_source_quality_weight_mode=product \
