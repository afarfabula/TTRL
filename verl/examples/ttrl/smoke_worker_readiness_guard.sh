...
987816    248    3800   8      NVIDIA-B200  fdbd:dccd:cde2:2131:0:e665:d5ca:9aea  9615   2026-07-07T09:59:56  https://example.invalid/"
...
run_case "multiple_workers" "multi" 2 "REASON=multiple workers are listed; keep exactly one worker before running v69"
run_case "healthy_single" "healthy" 0 "READINESS=PASS"

echo "WORKER_READINESS_GUARD_SMOKE_OK"
