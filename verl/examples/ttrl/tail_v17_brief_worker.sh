...
LOG_ROOT=/tmp/r17/ray/session_latest/logs
MAIN_LOG=/opt/tiger/TTRL/verl/sps_rule_conf_weight_floor015_clip05_power20_refbase_localfp32_8_50step_v17.log
...
echo "TAIL_V17_BRIEF_DATE $(date '+%F %T %Z')"
