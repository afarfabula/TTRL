...
LOG_ROOT=/tmp/r16/ray/session_latest/logs
MAIN_LOG=/opt/tiger/TTRL/verl/sps_rule_conf_weight_floor020_clip05_power15_refbase_localfp32_8_50step_v16.log
...
echo "TAIL_V16_BRIEF_DATE $(date '+%F %T %Z')"
