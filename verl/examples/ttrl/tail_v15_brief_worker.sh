...
LOG_ROOT=/tmp/r15/ray/session_latest/logs
MAIN_LOG=/opt/tiger/TTRL/verl/sps_rule_conf_weight_floor010_clip05_power15_refbase_localfp32_8_50step_v15.log
...
echo "TAIL_V15_BRIEF_DATE $(date '+%F %T %Z')"
