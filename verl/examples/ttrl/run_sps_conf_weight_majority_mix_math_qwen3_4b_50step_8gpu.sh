#!/bin/bash
# SPS confidence-weighted majority TTRL with mixed self-consistency reward.
...
#   4. Use the v4 continuous prompt weight, then mix in an unsupervised 0/1
#      self-consistency reward against the majority pseudo label. No true labels
...
export RAY_TMPDIR=${RAY_TMPDIR:-/tmp/ray_sps_conf_mix8}
...
$PY -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=math-qwen3_4b-sps-conf-weight-majority-mix-50step-8gpu \
