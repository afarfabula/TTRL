...
RUN_ID="ttrl_sharpened_grpo_b32_r32_v64_20step_dynbsz4096_top1ratio_noneg_20260730"
...
export TTRL_RUNTIME_DIR="/tmp/sr20"
...
exec bash "$SCRIPT" \
  ...
  ttrl.sharpened_reward_mode=top1_ratio \
