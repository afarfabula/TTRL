...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_support_flow_suffix_softrel_mid_c128_b32_r32_v64_3step_20260801}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0801-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-support-flow-suffix-softrel-3step-smoke}"
...
exec bash "$LAUNCHER" \
  ...
  ttrl.chunk_state_support_flow_score_type=soft_relative_mass \
