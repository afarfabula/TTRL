...
RUN_ID="ttrl_majvote_b32_r32_v64_20step_ablate_nogc_refmb8_20260730"
...
export TTRL_RUNTIME_DIR="/tmp/mv20_ablate_nogc_refmb8"
export OUTPUT_DIR="/tmp/ttrl_b200/checkpoints/${RUN_ID}"
export EXPERIMENT="${RUN_ID}"
export LOG_NAME="0730-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-grpo"
...
export ROLLOUT_LOG_PROB_MICRO_BATCH_SIZE=8
...
export ACTOR_GRADIENT_CHECKPOINTING=False
