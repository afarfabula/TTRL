...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_fullsupport_prior_softkeep_sourcepromptweight_nogates_mid_c128_probe1536x4_b32_r32_v64_3step_20260802}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0802-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-fullsupport-prior-softkeep-sourcepromptweight-nogates-smoke}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/cfsp82d}"
