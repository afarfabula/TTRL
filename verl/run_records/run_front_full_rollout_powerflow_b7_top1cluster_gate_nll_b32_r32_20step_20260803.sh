...
RUN_ID="$RUN_ID" \
EXPERIMENT="$RUN_ID" \
LOG_NAME="0803-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-fullrollout-b7-top1cluster-gate-nll-20step" \
TTRL_RUNTIME_DIR="/tmp/frb7g20" \
...
SAVE_FREQ=-1 \
bash run_records/ttrl_full_rollout_powerflow_b7_top1cluster_gate_nll_b32_r32_20step_20260803.sh 2>&1 | tee "$LOG"
