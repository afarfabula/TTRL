...
RUN_ID="${RUN_ID:-ttrl_sharpened_grpo_b8_r32_v64_20step_h100_restore_mvanchor_soft002_20260803}"
...
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/smva02h10020b8}"
export OUTPUT_DIR="${OUTPUT_DIR:-/tmp/ttrl_h100/checkpoints/${RUN_ID}}"
export EXPERIMENT="${EXPERIMENT:-$RUN_ID}"
export LOG_NAME="${LOG_NAME:-0803-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-grpo-h100-restore}"
