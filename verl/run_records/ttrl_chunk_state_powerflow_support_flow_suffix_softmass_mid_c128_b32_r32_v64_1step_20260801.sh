...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_support_flow_suffix_softmass_mid_c128_b32_r32_v64_1step_20260801}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0801-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-support-flow-suffix-softmass-smoke}"
