...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_label_consistent_c128_probe4_b32_r32_v64_3step_20260801}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0801-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-label-consistent-c128-powerflow}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/cslc128}"
...
exec bash "$BASE" \
  ...
  ttrl.chunk_state_min_majority_ratio=0.25 \
  ttrl.chunk_state_min_answer_coverage=0.60 \
  ttrl.chunk_state_confidence_power=0.0 \
