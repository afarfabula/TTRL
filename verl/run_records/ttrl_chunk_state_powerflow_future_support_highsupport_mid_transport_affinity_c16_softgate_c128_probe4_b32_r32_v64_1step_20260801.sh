...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_future_support_highsupport_mid_transport_affinity_c16_softgate_c128_probe4_b32_r32_v64_1step_20260801}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0801-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-highsupport-mid-affinity-c16-softgate-smoke}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/cfhsmac16}"
...
exec bash "$LAUNCHER" \
  ...
  ttrl.chunk_state_future_support_prior_smoothing=0.0 \
  ...
  ttrl.chunk_state_candidates=16 \
