...
RUN_ID="ttrl_sharpened_grpo_b32_r32_sdpa_dyn_3step_smoke_20260730"
...
export TTRL_RUNTIME_DIR="/tmp/sharp_sdpa_dyn_smoke"
export OUTPUT_DIR="/tmp/ttrl_b200/checkpoints/${RUN_ID}"
export EXPERIMENT="${RUN_ID}"
export LOG_NAME="0714-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-grpo"
...
export ACTOR_PPO_MAX_TOKEN_LEN_PER_GPU=8192
...
exec bash "$SCRIPT" \
  ...
  ttrl.sharpened_negative_reward=-0.25 \
