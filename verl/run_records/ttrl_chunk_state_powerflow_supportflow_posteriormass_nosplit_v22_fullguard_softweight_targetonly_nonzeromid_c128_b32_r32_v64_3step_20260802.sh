...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_supportflow_posteriormass_nosplit_v22_fullguard_softweight_targetonly_nonzeromid_c128_b32_r32_v64_3step_20260802}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0802-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-supportflow-posteriormass-nosplit-v22-fullguard-softweight-targetonly-smoke}"
