...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_futuregain_posteriormatch_v2_highsupport_softgate_mid_c128_probe1536x4_b32_r32_v64_3step_20260802}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0802-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-posterior-support-v2-highsupport-softgate-smoke}"
