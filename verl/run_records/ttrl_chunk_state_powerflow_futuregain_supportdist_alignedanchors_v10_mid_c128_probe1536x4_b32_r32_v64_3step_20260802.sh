...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_futuregain_supportdist_alignedanchors_v10_mid_c128_probe1536x4_b32_r32_v64_3step_20260802}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0802-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-support-distribution-alignedanchors-v10-smoke}"
...
exec bash "$BASE" \
  ...
  ttrl.chunk_state_support_anchor_prefix_compat_tokens=64 \
  ttrl.chunk_state_support_anchor_prefix_score_power=0.5 \
