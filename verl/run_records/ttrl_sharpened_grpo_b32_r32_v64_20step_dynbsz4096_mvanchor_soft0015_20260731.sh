...
RUN_ID="ttrl_sharpened_grpo_b32_r32_v64_20step_dynbsz4096_mvanchor_soft0015_20260731"
...
export TTRL_RUNTIME_DIR="/tmp/smva01520"
...
exec bash "$SCRIPT" \
  ...
  ttrl.sharpened_soft_coef=0.015 \
