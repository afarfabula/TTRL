...
RUN_ID="ttrl_sharpened_grpo_b32_r32_v64_20step_dynbsz4096_mvanchor_soft0025_20260731"
...
export TTRL_RUNTIME_DIR="/tmp/smva02520"
...
exec bash "$SCRIPT" \
  ...
  ttrl.sharpened_soft_coef=0.025 \
