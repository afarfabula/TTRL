...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_future_support_transport_affinity_masssrc_stategate_c128_probe4_b32_r32_v64_c16_1step_20260801}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0801-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-transport-affinity-masssrc-stategate-c16-smoke}"
export TTRL_RUNTIME_DIR="${TTRL_RUNTIME_DIR:-/tmp/cfsgc16}"
