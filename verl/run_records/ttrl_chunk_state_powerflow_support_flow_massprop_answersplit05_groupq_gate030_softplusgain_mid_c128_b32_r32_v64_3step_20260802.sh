...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_support_flow_massprop_answersplit05_groupq_gate030_softplusgain_mid_c128_b32_r32_v64_3step_20260802}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0802-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-support-flow-massprop-answersplit05-groupq-gate030-softplusgain-3step-smoke}"
