...
export RUN_ID="${RUN_ID:-ttrl_chunk_state_powerflow_futuregain_supportdist_mid_c128_probe3072x4_b32_r32_v64_3step_20260802}"
export EXPERIMENT="${EXPERIMENT:-${RUN_ID}}"
export LOG_NAME="${LOG_NAME:-0802-${RUN_ID}-MATH-TTT-Qwen2.5-Math-7B-support-distribution-match-probe3072-3step-smoke}"
